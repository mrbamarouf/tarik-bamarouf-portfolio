...
export const siteCopy = {
  en: {
    ...
    footer: {
      ...
      navigate: "Navigate",
      direct: "Direct",
      socialLabel: "BAMAROUF STUDIO social links",
      instagramLabel: "Visit BAMAROUF STUDIO on Instagram",
      tiktokLabel: "Visit BAMAROUF STUDIO on TikTok",
  ...
  ar: {
    ...
    footer: {
      headline:
        "تصميم المواقع، تجربة وواجهة المستخدم، والتجارب المتجاوبة، وتطوير الواجهات الأمامية.",
      whatsapp: "واتساب",
      email: "البريد",
      navigate: "التنقل",
      direct: "مباشر",
      socialLabel: "روابط بامعروف استديو الاجتماعية",
      instagramLabel: "زيارة بامعروف استديو على إنستقرام",
      tiktokLabel: "زيارة بامعروف استديو على تيك توك",
...
export const projectCopy: Record<string, Record<Language, ProjectCopy>> = {
  ...
  "bamarouf-studio": {
    ...
    ar: {
      ...
      intro:
        "BAMAROUF STUDIO هو بوابة رقمية راقية تجمع ثلاثة عوالم مهنية مستقلة تحت هوية معمارية واحدة. صُممت التجربة كبيت للمتخصصين، يتيح للزائر الدخول إلى عوالم التجارب الرقمية والتصميم الجرافيكي وهندسة الأنظمة، مع الحفاظ على شخصية وهوية كل تخصص بشكل مستقل.",
      details: {
        client: "BAMAROUF STUDIO",
      ...
      gallery: [
        {
          ...
          caption: "يعرض المشهد الافتتاحي ثلاث وجهات معمارية تحت هوية BAMAROUF STUDIO الهادئة.",
        },
        {
          title: "عالم نور",
      ...
      reflection:
        "أصبح BAMAROUF STUDIO منظومة رقمية مصقولة: عنوانًا معماريًا واحدًا لثلاثة عوالم متخصصة، لكل منها هويته وصوته وهدفه.",
    },
  },
  "khalid-bamarouf": {
    en: {
    ...
    ar: {
      ...
      disciplines: "تصميم وتطوير موقع إلكتروني",
      intro:
        "موقع احترافي صُمم لـ KHALID BAMAROUF لعرض هندسة الأنظمة وأتمتة الذكاء الاصطناعي والبنية الرقمية المتقدمة، ضمن هوية معمارية هادئة وفاخرة تركز على الدقة والوضوح.",
      details: {
        client: "KHALID BAMAROUF",
      ...
      overview: {
        ...
        approach:
          "صيغ الموقع حول لغة داكنة ومعمارية، وبنية تشغيل ذكية، وقدرات مرتبة، وسرد ثنائي اللغة يشرح ما يبنيه KHALID BAMAROUF وكيف يعمل.",
        outcome:
          "تضع التجربة النهائية KHALID BAMAROUF كمهندس أتمتة وأنظمة، وتربط الأتمتة، هندسة المؤسسات، الواجهات الخلفية، البنية السحابية، والتحول الرقمي داخل حضور واحد مركز.",
      },
      gallery: [
        {
          title: "الانترو / التحميل",
          caption: "تقدم لحظة الافتتاح شعار KHALID BAMAROUF داخل أجواء تحكم داكنة وواجهة أنظمة دقيقة.",
        },
        {
  ...
  "noor-bamarouf": {
    ...
    ar: {
      ...
      intro:
        "موقع أعمال ثنائي اللغة صُمم لـ NOOR BAMAROUF لعرض مشاريعها في الهوية البصرية والتغليف والطباعة والتصميم التحريري وتصميم محتوى التواصل الاجتماعي. تجمع التجربة بين درجات البيج الدافئة والوردي الهادئ والأخضر الفاتح، مع صور مرتبة بعناية وخطوط تحريرية تعكس حضورًا أنثويًا حديثًا واحترافيًا.",
      details: {
        client: "NOOR BAMAROUF",
      ...
      overview: {
        challenge:
          "احتاج المشروع إلى تقديم أعمال NOOR BAMAROUF في التصميم الجرافيكي بنعومة ووضوح وثقة مهنية، مع الحفاظ على هوية رقيقة وسهلة التذكر وتعمل باللغتين.",
        approach:
        ...
        outcome:
          "تمنح التجربة النهائية NOOR BAMAROUF موقع أعمال ثنائي اللغة يعرض الهوية البصرية والتغليف والطباعة ومحتوى التواصل الاجتماعي والتصميم التحريري والتوجيه الإبداعي ضمن حضور رقمي هادئ.",
      },
      gallery: [
        {
          title: "الواجهة الرئيسية / تكوين ماتشا",
          caption:
            "يقدم المشهد الافتتاحي عالم NOOR BAMAROUF البصري عبر صور تغليف ناعمة، مساحات دافئة، درجات أخضر هادئة، وتكوين تحريري متزن.",
        },
        {
          title: "التعريف / مرحبًا، أنا نور",
          caption:
            "يعرض قسم التعريف NOOR BAMAROUF كمصممة جرافيك مستقلة بحضور هادئ وأنثوي ومهني.",
        },
        {
      ...
      reflection:
        "أصبح المشروع موقع أعمال تحريريًا ناعمًا يجمع التجربة الثنائية اللغة، تصميم تجربة وواجهة المستخدم، التوجيه البصري، تطوير الواجهة المتجاوبة، ونظام عرض راق لأعمال NOOR BAMAROUF في التصميم الجرافيكي.",
    },
  },
  "osama-bin-mahfouz-law-firm": {
    ...
    ar: {
      ...
      disciplines: "تصميم وتطوير موقع إلكتروني",
      intro:
        "موقع ثنائي اللغة صُمم لـ Osama Bin Ahmed Bin Mahfouz Law Firm، يجمع بين الطابع المعماري السعودي والوضوح المهني والهوية البصرية الراقية والهادئة. يقدم الموقع تعريفًا بالمكتب وخدماته القانونية وقنوات التواصل المباشر ضمن تجربة عربية وإنجليزية منظمة.",
      details: {
        client: "Osama Bin Ahmed Bin Mahfouz Law Firm",
...
export function projectDisplay(slug: string, language: Language) {
  const copy = projectCopy[slug]?.[language] ?? {};
  const officialCopy = projectCopy[slug]?.en;

  if (!officialCopy) return copy;

  return {
    ...copy,
    name: officialCopy.name ?? copy.name,
    details: copy.details
      ? {
          ...copy.details,
          client: officialCopy.details?.client ?? copy.details.client,
        }
      : copy.details,
  };
}
